...
# ⚠️  DO NOT import sentence_transformers or chromadb at module level.
# They are imported lazily inside functions so nothing loads on import.
# vector_store helpers are also called lazily inside each function.
...
def ingest_pdf(
    ...
    Model and DB are loaded here on first call, not on import.
    """
    from vector_store import get_model, get_collection  # lazy
...
def delete_pdf_from_kb(filename: str) -> Dict[str, any]:
    ...
    from vector_store import get_collection  # lazy
...
def rebuild_entire_kb_from_pdfs(pdf_directory: str = "./uploaded_pdfs") -> Dict[str, any]:
    ...
    """
    from vector_store import reset_collection  # lazy
